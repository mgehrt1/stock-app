    ...
    <header className="bg-blue-900">
      ...
      >
        <div className="flex lg:flex-1">
          <a
            href="/"
            className="flex items-center bg-white rounded-tl-3xl rounded-br-3xl"
          >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12 bg-stone-100 shadow-lg  nav-md-add-on nav-md-animate">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-base font-semibold leading-6 text-gray-900 navbar-link underline">
              Stocks
              <ChevronDownIcon
          ...
          <a
            href="/explore"
            className="text-base font-semibold leading-6 text-gray-900 navbar-link underline"
          >
            Explore
          </a>
          <a
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          {loading ? null : !user ? (
            <a
              href="/sign-in"
              className="text-lg font-semibold leading-6 text-white login-link underline"
            >
